...
#include "mprmpr/rpc/reactor.h"
#include "mprmpr/rpc/remote_method.h"
#include "mprmpr/rpc/result_tracker.h"
#include "mprmpr/rpc/rpc_context.h"
#include "mprmpr/rpc/rpc_sidecar.h"

#include "mprmpr/tests/rpc/rtest.pb.h"
#include "mprmpr/tests/rpc/rtest.proxy.pb.h"
#include "mprmpr/tests/rpc/rtest.service.pb.h"
...
#include "mprmpr/util/random_util.h"
#include "mprmpr/util/stopwatch.h"
...
using mprmpr::rpc_test::AddRequestPB;
using mprmpr::rpc_test::AddRequestPartialPB;
using mprmpr::rpc_test::AddResponsePB;
using mprmpr::rpc_test::CalculatorError;
using mprmpr::rpc_test::CalculatorServiceIf;
using mprmpr::rpc_test::CalculatorServiceProxy;
using mprmpr::rpc_test::EchoRequestPB;
using mprmpr::rpc_test::EchoResponsePB;
using mprmpr::rpc_test::ExactlyOnceRequestPB;
using mprmpr::rpc_test::ExactlyOnceResponsePB;
using mprmpr::rpc_test::FeatureFlags;
using mprmpr::rpc_test::PanicRequestPB;
using mprmpr::rpc_test::PanicResponsePB;
using mprmpr::rpc_test::SendTwoStringsRequestPB;
using mprmpr::rpc_test::SendTwoStringsResponsePB;
using mprmpr::rpc_test::SleepRequestPB;
using mprmpr::rpc_test::SleepResponsePB;
using mprmpr::rpc_test::TestInvalidResponseRequestPB;
using mprmpr::rpc_test::TestInvalidResponseResponsePB;
using mprmpr::rpc_test::WhoAmIRequestPB;
using mprmpr::rpc_test::WhoAmIResponsePB;
using mprmpr::rpc_test_diff_package::ReqDiffPackagePB;
using mprmpr::rpc_test_diff_package::RespDiffPackagePB;
...
class CalculatorService : public CalculatorServiceIf {
 public:
  ...
  void TestArgumentsInDiffPackage(const ReqDiffPackagePB *req,
                                  ...
                                  ::mprmpr::rpc::RpcContext *context) override {
    context->RespondSuccess();
  }
...
const char *GenericCalculatorService::kFullServiceName = "mprmpr.rpc.GenericCalculatorService";
...
class RpcTestBase : public AntTest {
 ...
 protected:
  ...
  std::shared_ptr<mprmpr::MemTracker> mem_tracker_;
