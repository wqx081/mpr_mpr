...
TEST_F(DebugUtilTest, TestStackTrace) {
  ...
  ASSERT_STR_CONTAINS(trace, "mprmpr::DebugUtilTest_TestStackTrace_Test::TestBody");
}
...
TEST_F(DebugUtilTest, TestStackTraceSelf) {
  ...
  ASSERT_STR_CONTAINS(s, "mprmpr::DebugUtilTest_TestStackTraceSelf_Test::TestBody()");
}

TEST_F(DebugUtilTest, TestStackTraceMainThread) {
  string s = DumpThreadStack(getpid());
  ASSERT_STR_CONTAINS(s, "mprmpr::DebugUtilTest_TestStackTraceMainThread_Test::TestBody()");
}
