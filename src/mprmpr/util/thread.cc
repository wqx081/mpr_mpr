...
METRIC_DEFINE_gauge_uint64(server, cpu_utime,
                           "User CPU Time",
                           mprmpr::MetricUnit::kMilliseconds,
...
METRIC_DEFINE_gauge_uint64(server, voluntary_context_switches,
                           ...
                           mprmpr::MetricUnit::kContextSwitches,
